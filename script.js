...
// 3. Обработчик ошибок - замена попытки ввода текста на значение по умолчанию. 
// 4. При выводе сообщения об ошибке дергалось модальное окно, устранено.
// 5. Ошибка в макете - задвоенный класс слоя, устранено.
// 6. Исправлено оформление страницы, сделан контрастный цвет для вывода чисел.
